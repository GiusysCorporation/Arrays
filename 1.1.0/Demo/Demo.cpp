...
void demoForFixedArray() {
    ...
    for(int i = 0; i < ar.size(); i++) {
        ...
        ar.set(i, (Types::Object*) new Types::Primitives::Int(n));
    }

    std::cout << "\nThese are the values saved in the array:\n";
    for(int i = 0; i < ar.size(); i++) std::cout << "\a" << i + 1 << ". " << ((Types::Primitives::Int*) ar.atIndex(i))->value << "\n";
}
